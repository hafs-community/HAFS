module netcdf_interface
  ...
  interface netcdf_interface_putvar
     ...
     module procedure putvar_int_2d
...
contains
  ...
  ! This subroutine retrieves a 4-byte real-valued 1-dimensional array
  ! attribute from a netcdf file.
  ...
  ! * var; a FORTRAN 4-byte real-valued variable array to contain the
  !   netcdf attribute value array.
  ...
  ! * var; a FORTRAN 4-byte real-valued variable array specifying the
  !   netcdf attribute value array.

  !-----------------------------------------------------------------------

  subroutine getattr_real_1d(filename,attrname,var,varname)
  ...
  end subroutine getattr_real_1d
  ...
  ! * var; a FORTRAN 1-dimensional 8-byte precision variable array to
  ...
  subroutine getvar_double_1d(filename,varname,var)
  ...
  end subroutine getvar_double_1d
  ...
  ! * var; a FORTRAN 2-dimensional integer variable array to contain
  !   the contents of the user specified netcdf variable.

  ! OUTPUT VARIABLES:

  ! * var; a FORTRAN 2-dimensional integer variable array containing
  !   the contents of the user specified netcdf variable.

  !-----------------------------------------------------------------------

  subroutine getvar_int_2d(filename,varname,var)
    ...
    integer,                    dimension(:,:),             allocatable :: workgrid
    integer                                                             :: d1
    integer                                                             :: d2
  ...
  ! * fill_value; a FORTRAN 4-byte float value used to signify missing
  !   data values; defaults to 'spval' is not specified.

  !-----------------------------------------------------------------------

  subroutine netcdf_interface_writedef(varinfo,fill_value)

    ! Define variables passed to routine

    type(varinfo_struct)                                                :: varinfo
    real(r_kind),       optional                                        :: fill_value                                                      

    ! Define variables computed within routine

    real(r_kind)                                                        :: fill_value_n
    ...
    if(present(fill_value)) then
       ...
       fill_value_n = fill_value

    else   ! if(present(fill_value)) 

       ! Define local variables

       fill_value_n = spval

    end if ! if(present(fill_value)) 
    ...
    do i = 1, varinfo%nvars
       ...
       do j = 1, varinfo%varnattrs(i)
          ...
          if(varinfo%vartype(i) .eq. 'float') then
             ...
             ncstatus = nf90_put_att(ncfileid,varinfo%varid(i),             &
                  & '_FillValue',fill_value_n)
             ncstatus = nf90_put_att(ncfileid,varinfo%varid(i),             &
                  & 'missing_value',fill_value_n)
  ...
  ! This subroutine writes a 8-byte real-valued variable to a user
  ! specified netcdf file in accordance with the user supplied netcdf
  ! API key.
  ...
  ! * var; a FORTRAN 1-dimensional 8-byte precision variable
  !   containing the contents of the user specified netcdf variable.
  ...
  ! This subroutine writes a 1-dimensional 8-byte real-valued variable
  ! to a user specified netcdf file in accordance with the user
  ! supplied netcdf API key.
  ...
  ! This subroutine writes a 2-dimensional 8-byte real-valued variable
  ! to a user specified netcdf file in accordance with the user
  ! supplied netcdf API key.
  ...
  ! This subroutine writes a 2-dimensional variable to a user
  ! specified netcdf file in accordance with the user supplied netcdf
  ! API key.
  ...
  subroutine putvar_int_2d(filename,varname,var)
  ...
  ! This subroutine writes a 1-dimensional variable to a user
  ! specified netcdf file in accordance with the user supplied netcdf
  ! API key.
  ...
  ! This subroutine writes a 3-dimensional variable to a user
  ! specified netcdf file in accordance with the user supplied netcdf
  ! API key.
  ...
  ! This subroutine writes a 4-dimensional variable to a user
  ! specified netcdf file in accordance with the user supplied netcdf
  ! API key.
