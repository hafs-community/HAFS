...
c
c     generate orthogonal vector with 
c     random numbers using Fortran90
c     intrinsics RANDOM_{SEED, NUMBER}
c
c     comment out old code
c
c     do i=1,nte
c     xx(i) = rand()
c     end do
...
c
c     old code with nonstandard (s)rand
c     commented out
c
c     do i=1,nte
c     xx(i) = rand()
c     end do
c
c     replacement code with standard Fortran90 
c     intrinsic
c
      CALL RANDOM_NUMBER(xx(1:nte))
