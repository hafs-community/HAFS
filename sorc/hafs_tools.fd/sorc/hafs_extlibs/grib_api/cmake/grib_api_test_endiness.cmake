...
if( _BIG_ENDIAN )
        set( GRIB_API_BIG_ENDIAN    1 )
        set( GRIB_API_LITTLE_ENDIAN 0 )
else()
        set( GRIB_API_BIG_ENDIAN    0 )
        set( GRIB_API_LITTLE_ENDIAN 1 )
endif()

set( GRIB_API_BIG_ENDIAN    ${GRIB_API_BIG_ENDIAN}    )
set( GRIB_API_LITTLE_ENDIAN ${GRIB_API_LITTLE_ENDIAN} )
...
if( GRIB_API_BIG_ENDIAN AND NOT IEEE_BE )
...
if( GRIB_API_LITTLE_ENDIAN AND NOT IEEE_LE )
