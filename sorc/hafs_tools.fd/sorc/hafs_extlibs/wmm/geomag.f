...
C
C
      SUBROUTINE GEOMAG(MAXDEG,EPOCH,COF_FILE)
C
      IMPLICIT NONE
C
      CHARACTER*500 COF_FILE
      INTEGER MAXDEG
      REAL EPOCH
C
...
C      EQUIVALENCE (SNORM,P)
      ...
      OPEN (UNIT=9,FILE=TRIM(ADJUSTL(COF_FILE)))
C
C
C
C
...
C
C
      SUBROUTINE GEOMG1(ALT,GLAT,GLON,TIME,DEC,DIP,TI,GV,EPOCH)
C
      IMPLICIT NONE
C
      INTEGER N, M, MAXORD
