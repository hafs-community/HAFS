...
C
C     THESE ARE FOR A CRAY_X1 UNDER FTN (REAL*4).
C
C-----------------------------------------------------------------------
C
...
C
C 3)  THIS VERSION IS FOR CRAY_X1 UNDER FTN (REAL*4).
...
C     SEE ALSO, ZHOPNC.
C
C 2)  THIS VERSION IS FOR THE CRAY_X1 UNDER FTN (REAL*4).
...
C
C     ON THE CRAY_X1, LEN AND -LEN BOTH GIVE IEEE FILES.
C
...
C
C 3)  THIS VERSION FOR THE CRAY_X1, IT USES THE
...
C
C 2) THIS VERSION FOR THE CRAY_X1 UNDER FTN (REAL*4).
C
...
C     ON THE CRAY_X1 USING PXFGETENV.
C
