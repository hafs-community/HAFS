#!/bin/sh
################################################################################
# Script Name: exhafs_post.sh
# Authors: NECP/EMC Hurricane Project Team and UFS Hurricane Application Team
# Abstract:
#   This script runs the atmospheric post-processing steps including
...
DATApost=${DATApost:-${DATA:-${WORKhafs}/atm_post${POST_GROUPI}}}
INPdir=${INPdir:-${WORKhafs}/intercom/forecast}
COMOUTpost=${COMOUTpost:-${COMhafs}}
intercom=${intercom:-${WORKhafs}/intercom/post}
RESTARTcom=${RESTARTcom:-${COMhafs}/${out_prefix}.RESTART}
...
DATA_POST=${DATApost}/post${neststr}_${NEWDATE}
rm -rf ${DATA_POST}
mkdir -p ${DATA_POST}
cd ${DATA_POST}
