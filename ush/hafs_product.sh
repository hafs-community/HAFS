#!/bin/sh
################################################################################
# Script Name: hafs_product.sh
# Authors: NECP/EMC Hurricane Project Team and UFS Hurricane Application Team
# Abstract:
#   This script runs the GFDL vortex tracker for the atmospheric parent or nest
#   grid to generate the ATCF track files, and produces the stakeholder
#   (NHC/JTWC) needed products (if desired).
################################################################################
set -xe
...
DATAprod=${DATAprod:-${WORKhafs}/product}
...
DATA_tracker=${DATAprod}/tracker${neststr}
...
if [ ${COMOUTproduct} = ${COMhafs} ] && [ -s ${COMhafs}/${trk_atcfunix} ]; then
  mkdir -p ${DATAprod}/nhc_products
  cd ${DATAprod}/nhc_products
