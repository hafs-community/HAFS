...
################################################################################
# Script Name: exhafs_force_warmstart.sh
# ADAPTED FROM exhafs_forecast.sh
# Authors: HRD/CIMAS, NCEP/EMC Hurricane Project Team and UFS HAT
# Abstract:
#   This script replicates the file copy/link commands that should follow a
#   successful forecast run, allowing warmstart in succeeding cycles.
# History:
...
#   06/01/2025: Adapt from multistorm/force_warmstart and v2.1 forecast scripts
# Condition codes:
#   == 0 : success
...
if [ ${RUN_MULTISTORM} == "YES" ] && [ ${RUN_INIT:-NO} = "NO" ]; then
 ...
 # Lew.Gramer@noaa.gov 2025-06-22
