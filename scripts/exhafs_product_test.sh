...
if [ "${ENSDA}" = YES ]; then
  ...
  INPdir=${WORKhafs}/intercom/atm_merge_init_fgat${FGAT_HR}/post
  intercom=${WORKhafs}/intercom/atm_merge_init_fgat${FGAT_HR}
  COMOUTproduct=${WORKhafs}/intercom/atm_merge_init_fgat${FGAT_HR}
  NHRS=0
else
  INPdir=${WORKhafs}/intercom/atm_merge_init/post
  intercom=${WORKhafs}/intercom/atm_merge_init
  COMOUTproduct=${WORKhafs}/intercom/atm_merge_init
  NHRS=0
fi
