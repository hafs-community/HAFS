...
halo=${HALO}
maximum_snow_albedo_method="nearest_stod"
snowfree_albedo_method="nearest_stod"
vegetation_greenness_method="nearest_stod"
substrate_temperature_method="nearest_stod"
!leaf_area_index_method="nearest_stod"
/
EOF
