...
logger = Logger('BUFR_vadwnd.py', level=log_level, colored_log=False)
...
def _make_obs(comm, input_path, mapping_path):
    ...
    logging(comm, 'DEBUG', f'prepbufrDataLvlCat')
    cat = container.get('variables/prepbufrDataLvlCat')
