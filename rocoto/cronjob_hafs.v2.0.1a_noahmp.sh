...
#===============================================================================
 ...
 # HAFSv2.0.1A configuration with NOAHMP LSM
 confopts="config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p0p1a_noahmp \
     ../parm/hafs.v2.0.1a_noahmp.conf"
 #   dir.COMrtofs=/lfs/h2/emc/hur/noscrub/hafs-input/COMRTOFSv2.5 ../parm/hafs.v2.0.1a_noahmp.conf"
