...
HOMEhafs=/scratch4/AOML/aoml-hafs1/Lew.Gramer/HAFSV2.2.1M_2026_RT.POST_MERGE
...
opts="-t -f"
opts_RES="-t -s sites/ursa_reservation.ent -f"
#===============================================================================
# HAFSv2.2B final configuration
 confopts_a="config.EXPT=${EXPT} ../parm/hafsv2p3a_final.conf"
 confopts_b="config.EXPT=${EXPT} ../parm/hafsv2p3b_final.conf"


#################### HAFS-B Multi REAL-TIME

# 2026: Real-time

./run_hafs.py ${opts} -M E,C 2026072318-2026072712 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_Pac \
   grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

./run_hafs.py ${opts} -M L 2026072318-2026072712 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

# # 2026: AMANDA01E, BORIS02E, CHRISTINA03E: 2026060118-2026061100
# ./run_hafs.py ${opts} -M E,C 2026060118-2026061100 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_Pac \
#    grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
#    config.NHRS=174 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no


#################### HAFS-B Multi *NON-IAU* TEST
...
./run_hafs.py ${opts} -M L 2024062818-2024070818 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}.NON_IAU_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf ../parm/hafs_noniau.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} -M L 2024090806-2024091806 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}.NON_IAU_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf ../parm/hafs_noniau.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} -M L 2024092218-2024101212 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}.NON_IAU_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf ../parm/hafs_noniau.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
#./run_hafs.py ${opts} 2025081112-2025082212 05L HISTORY ${confopts} # Erin (+ MULTIPLE INVESTS)
./run_hafs.py ${opts} -M L 2025081112-2025082212 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}.NON_IAU_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf ../parm/hafs_noniau.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
#################### HAFS-B Multi Retros (GFS v17 + JEDI + IAU)

########## 2022/3 (RETROS WITH MISSING v17 DATA ON URSA)

# # 2022: (just) BONNIE->COLIN
# ./run_hafs.py ${opts} -M L 2022062318-2022070306 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
#    grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
#    config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

# # 2023: FRANKLIN->IDALIA->KATIA->LEE: 
# ./run_hafs.py ${opts} -M L 2023081906-2023091712 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
#    grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
#    config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

# # 2023: DORA->EUGENE->FERNANDA->GREG->HILARY->IRWIN->JOVA: 
# ./run_hafs.py ${opts} -M E,C 2023073000-2023091018 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Pac \
#    grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
#    config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
# ./run_hafs.py ${opts} 2024062818-2024070818 02L HISTORY config.SUBEXPT=${EXPT}_A ../parm/hafsv2p2p1a_final.conf \
#    config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

#./run_hafs.py ${opts} 2024062818-2024070818 02L HISTORY ${confopts} # Beryl
#./run_hafs.py ${opts} 2024063018-2024070100 03L HISTORY ${confopts} # Chris
./run_hafs.py ${opts} -M L 2024062818-2024070818 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
#./run_hafs.py ${opts} 2024091112-2024091806 07L HISTORY ${confopts} # Gordon
#./run_hafs.py ${opts} 2024091500-2024091612 08L HISTORY ${confopts} # Eight
./run_hafs.py ${opts} -M L 2024090806-2024091806 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

# ./run_hafs.py ${opts} 2024092312-2024092712 09L HISTORY ../parm/hafsv2p2p1a_final.conf config.SUBEXPT=${EXPT}_A \
#    config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
# ./run_hafs.py ${opts} 2024092918-2024100706 12L HISTORY ../parm/hafsv2p2p1a_final.conf config.SUBEXPT=${EXPT}_A \
#    config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
# ./run_hafs.py ${opts} 2024100512-2024101012 14L HISTORY ../parm/hafsv2p2p1a_final.conf config.SUBEXPT=${EXPT}_A \
#    config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
#./run_hafs.py ${opts} 2024100212-2024101212 13L HISTORY ${confopts} # Leslie
#./run_hafs.py ${opts} 2024100512-2024101012 14L HISTORY ${confopts} # Milton
./run_hafs.py ${opts} -M L 2024092218-2024101212 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
#./run_hafs.py ${opts} 2025081112-2025082212 05L HISTORY ${confopts} # Erin (+ MULTIPLE INVESTS)
./run_hafs.py ${opts} -M L 2025081112-2025082212 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} -M E,C 2024101218-2024102212 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

#./run_hafs.py ${opts} 2024110118-2024110406 17L HISTORY ${confopts} # Patty
#./run_hafs.py ${opts} 2024110400-2024111018 18L HISTORY ${confopts} # Rafael
./run_hafs.py ${opts} -M E,C 2024110118-2024111018 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} -M E,C 2024073112-2024080818 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Pac \
   grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

#./run_hafs.py ${opts} 2024081812-2024083000 07E HISTORY ${confopts} # Gilma
#./run_hafs.py ${opts} 2024082218-2024090118 01C HISTORY ${confopts} # Hone
...
# 2024: GILMA07E->HONE01C->HECTOR08E: 2024081806-2024082918
./run_hafs.py ${opts} -M E,C 2024081806-2024082918 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Pac \
   grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
# 2024: JOHN->INVEST91C->INVEST94E->INVEST97E->INVEST98E->INVEST99E (*no data* for 2024092200-2024092206):
./run_hafs.py ${opts} -M E,C 2024092212-2024101000 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Pac \
   grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
#./run_hafs.py ${opts} -M E,C 2024103118-2024110712 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Pac # MISSING DATA
./run_hafs.py ${opts} -M E,C 2024110112-2024110712 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Pac \
   grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} -M L 2025091512-2025100212 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} -M L 2025100706-2025101112 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} -M L 2025102100-2025103106 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Atl \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

##### Pac

# 2025: IONA01C->KELI02C->INVEST98E->INVEST99E (*no data* for 20250726-20250802):
./run_hafs.py ${opts} -M E,C 2025072600-2025080400 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Pac \
   grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} -M E,C 2025060800-2025061106 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Pac \
   grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} -M E,C 2025073100-2025080306 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Pac \
   grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} -M E,C 2025091918-2025101200 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_R_Pac \
   grid.nest_grids=3 ../parm/hafs_multistorm_pacific_jedi.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no
...
./run_hafs.py ${opts} 2025102300-2025102400 13L HISTORY ${confopts_a} \
  config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_emcgraphics=yes

#### HAFS-B (single storm v2.3) Tests
# Five cycle testing for Melissa 13L2025
./run_hafs.py ${opts} 2025102300-2025102400 13L HISTORY ${confopts_b} \
  config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_emcgraphics=yes

#### HAFS-B v2.2.1 Multi JEDI test cases

./run_hafs.py ${opts} -M L 2024100600-2024100712 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_v17_JEDI_Atlantic_TEST \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
...
# FRANKLIN->IDALIA->KATIA->LEE: 
./run_hafs.py ${opts} -M L,E 2023081906-2023091712 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_RETRO \
   grid.nest_grids=3 ../parm/hafs_multistorm.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

# Helene, Isaac, Joyce, Kirk, Leslie, Milton block
./run_hafs.py ${opts} -M L,E 2024092218-2024101212 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_RETRO \
   grid.nest_grids=3 ../parm/hafs_multistorm.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no


# MARIO->GABRIELLE->NARDA->HUMBERTO->IMELDA block: 2025091512-2025100212
./run_hafs.py ${opts} -M L,E 2025091512-2025100212 00L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_RETRO \
   grid.nest_grids=3 ../parm/hafs_multistorm.conf \
   config.NHRS=126 config.scrub_work=yes config.scrub_com=yes config.run_hrdgraphics=yes config.run_emcgraphics=no

# Instability in outer domain? 2023082700 "M" forecast below crashes: reproduce in A or B?
#./run_hafs.py ${opts} 2025081306-2025081318 05L HISTORY ${confopts} # Erin
./run_hafs.py ${opts} 2025081306-2025081318 05L HISTORY ${confopts_a} config.SUBEXPT=${EXPT}_singlestorm_A \
   config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no #Erin
./run_hafs.py ${opts} 2025081306-2025081318 05L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_singlestorm_B \
   config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no #Erin
