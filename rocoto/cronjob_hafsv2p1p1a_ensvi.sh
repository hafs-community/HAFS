...
HOMEhafs=/scratch3/NCEPDEV/hwrf/save/Xu.Lu/hafsv2p1_ensvr_disk
...
# HAFSv2.1.1A 4DEnVar with mixed 40 HAFS ensembles and 80 GDAS ensembles
 confopts="config.EXPT=${EXPT} config.SUBEXPT=ensvr_disk ../parm/hafsv2p1p1a_ensvi.conf "
## Technical testing for Helene 09L2024
#./run_hafs.py ${opts} 2024081412-2024081418 05L HISTORY ${confopts} \
...
#./run_hafs.py ${opts} 2024081118-2024081200 05L HISTORY ${confopts} # Ernesto
