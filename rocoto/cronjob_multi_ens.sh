...
export HOMEhafs=/scratch3/HFIP/hwrfv3/save/Xu.Lu/hafsv2p2_phase2_multistorm_20260522_JEDI
...
./run_hafs.py ${opts} -M L 2024092406-2024092412 00L HISTORY ${confopts} config.SUBEXPT=MULTI_JEDI_ORG \
   grid.nest_grids=3 ../parm/hafs_multistorm_atlantic_jedi.conf \
   config.NHRS=12 config.scrub_work=no config.scrub_com=no 

./run_hafs.py ${opts} -M L 2024092406-2024092412 00L HISTORY ${confopts} config.SUBEXPT=MULTI_JEDI_TEST \
