...
#===============================================================================
 ...
 confopts_a="config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p1a_phase3 \
...
#    dir.COMrtofs=/gpfs/f6/drsa-hurr1/world-shared/noscrub/hafs-input/COMRTOFSv2.5_new" # gaeaC6
 ...
 # Technical testing
# ./run_hafs.py ${opts} 2024092506-2024092512 09L HISTORY ${confopts_a} config.SUBEXPT=${EXPT}_v2p1a_phase3_test # Helene

# ./run_hafs.py ${opts} 2024100606-2024100612 14L HISTORY ${confopts_a} config.SUBEXPT=${EXPT}_v2p1a_phase3_test # Milton

#===============================================================================
 # HAFSv2.1B phase3 configuration
 confopts_b="config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p1b_phase3 \
    ../parm/hafsv2p1b_phase3.conf"
#    dir.COMrtofs=/scratch1/NCEPDEV/hwrf/noscrub/hafs-input/COMRTOFSv2.5_new" # hera
#    dir.COMrtofs=/lfs/h2/emc/hur/noscrub/hafs-input/COMRTOFSv2.5_new" # wcoss2
#    dir.COMrtofs=/work/noaa/hwrf/noscrub/hafs-input/COMRTOFSv2.5_new" # orion/hercules
#    dir.COMrtofs=/lfs5/HFIP/hwrf-data/hafs-input/COMRTOFSv2.5_new" # jet
#    dir.COMrtofs=/gpfs/f6/drsa-hurr1/world-shared/noscrub/hafs-input/COMRTOFSv2.5_new" # gaeaC6
 ...
 # Technical testing
# ./run_hafs.py ${opts} 2024092506-2024092512 09L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_v2p1b_phase3_test # Helene

# ./run_hafs.py ${opts} 2024100606-2024100612 14L HISTORY ${confopts_b} config.SUBEXPT=${EXPT}_v2p1b_phase3_test # Milton

 # Coldstart test
#./run_hafs.py ${opts} 2024100506 14L HISTORY ${confopts_b} # Milton

#===============================================================================
 # HAFSv2.1M phase3 configuration
 confopts_m="config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p1m_phase3 \
    grid.nest_grids=3 config.run_hrdgraphics=yes ../parm/hafsv2p1m_phase3.conf"
#    dir.COMrtofs=/scratch1/NCEPDEV/hwrf/noscrub/hafs-input/COMRTOFSv2.5_new" # hera
#    dir.COMrtofs=/lfs/h2/emc/hur/noscrub/hafs-input/COMRTOFSv2.5_new" # wcoss2
#    dir.COMrtofs=/work/noaa/hwrf/noscrub/hafs-input/COMRTOFSv2.5_new" # orion/hercules
#    dir.COMrtofs=/lfs5/HFIP/hwrf-data/hafs-input/COMRTOFSv2.5_new" # jet
...
#               grid.nest_grids=3 config.run_hrdgraphics=yes \
#               ../parm/hfsb_regional_multistorm_ocean_DA_workflow_largedomain_15west_gsi_d02.conf

# ./run_hafs.py ${opts} -M L,E 2024100706-2024100712 00L HISTORY \
#               config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p1m_gridfix \
#               grid.nest_grids=3 config.run_hrdgraphics=yes \
#               ../parm/multi_gridfix.conf

# Milton
# # # ./run_hafs.py ${opts} -M L,E 2024100706-2024100712 00L HISTORY \
# # #               config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p1m_gridfix_Gopal_issue \
# # #               grid.nest_grids=3 config.run_hrdgraphics=yes \
# # #               ../parm/multi_gridfix.conf
# # ./run_hafs.py ${opts} -M L,E 2024100500-2024100718 00L HISTORY \
# #               config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p1m_gridfix_Gopal_issue \
# #               grid.nest_grids=3 config.run_hrdgraphics=yes \
# #               ../parm/multi_gridfix.conf
# ./run_hafs.py ${opts} -M L,E 2024100500-2024100718 00L HISTORY ${confopts_m} \
#               config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p1m_Gopal_issue \
#               grid.nest_grids=3 config.run_hrdgraphics=yes
# # # ./run_hafs.py ${opts} -M L,E 2024100500-2024100718 00L HISTORY ${confopts_m} \
# # #               config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p1m_Gopal_v2p0_issue \
# # #               grid.nest_grids=3 config.run_hrdgraphics=yes

 # Coldstart test
#./run_hafs.py ${opts} -M L,E 2024100506 00L HISTORY ${confopts_m}config.SUBEXPT=${EXPT}_v2p1m_phase3_coldstart_test  # Milton
