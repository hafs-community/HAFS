...
HOMEhafs=/scratch4/HFIP/hur-aoml/Lew.Gramer/hafsv2p2_baseline_multistorm
...
opts="-t -f"
#===============================================================================
# HAFSv2.2B baseline configuration
 confopts="config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p2b_baseline ../parm/hafsv2p2b_baseline.conf"

# # Baseline testing for Helene 09L2024
# ./run_hafs.py ${opts} 2024092406-2024092412 09L HISTORY ${confopts} config.SUBEXPT=${EXPT}_v2p2b_baseline_technical_test \
#    config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no

# Incremental testing for Helene 09L2024
./run_hafs.py ${opts} 2024092406-2024092412 09L HISTORY ${confopts} config.SUBEXPT=${EXPT}_v2p2b_baseline_workflow_test \
   config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no

# ./run_hafs.py ${opts} 2025102106-2025103112 13L HISTORY ${confopts} config.SUBEXPT=${EXPT}_v2p2b_baseline_workflow_test \
#    config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no #Melissa
./run_hafs.py ${opts} 2025102106-2025102112 13L HISTORY ${confopts} config.SUBEXPT=${EXPT}_v2p2b_baseline_workflow_test \
   config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no #Melissa

# # Incremental testing for Helene 09L2024 - MULTISTORM
# ./run_hafs.py ${opts} -M L,E 2024092406-2024092412 00L HISTORY ${confopts} config.SUBEXPT=${EXPT}_v2p2b_baseline_multistorm_test \
#    grid.nest_grids=3 ../parm/hafs_multistorm.conf \
#    config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no

# # Incremental testing for Helene 09L2024 - MULTISTORM with 40 nodes
# ./run_hafs.py ${opts} -M L,E 2024092406-2024092412 00L HISTORY ${confopts} config.SUBEXPT=${EXPT}_v2p2b_baseline_multistorm_40_node \
#    grid.nest_grids=3 ../parm/hafs_multistorm.conf \
#    config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no

# # Incremental testing for Helene 09L2024 - MULTISTORM with 40 nodes but with only B options
# ./run_hafs.py ${opts} -M L,E 2024092406-2024092412 00L HISTORY ${confopts} config.SUBEXPT=${EXPT}_v2p2b_baseline_multistorm_40_node_only_b \
#    grid.nest_grids=3 \
#    config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no

# Incremental testing for Helene 09L2024 - MULTISTORM with 40 nodes but with only M options
./run_hafs.py ${opts} -M L,E 2024092406-2024092412 00L HISTORY config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p2b_baseline_multistorm_40_node_only_m \
   grid.nest_grids=3 ../parm/hafs_multistorm.conf \
   config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no

# Incremental testing for Helene 09L2024 - MULTISTORM with 40 nodes with option lists only for 0- and 1-storm case: REMOVE OPTIONS
./run_hafs.py ${opts} -M L,E 2025101806-2025101812 00L HISTORY ${confopts} \
   config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p2b_baseline_multistorm_40_node_1_storm ../parm/hafsv2p2b_baseline.conf
   grid.nest_grids=3 ../parm/hafs_multistorm_1_storm.conf \
   config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_hrdgraphics=yes config.run_emcgraphics=no
