...
#===============================================================================
 ...
 ./run_hafs.py ${opts} 2021082712 09L HISTORY ${confopts} \
     config.NHRS=72 ${scrubopt} config.run_emcgraphics=yes

## HAFS tutorial test 4a: HAFSv2A configuration with dev computation resources
## and without wave coupling for 126-h forecast
## Hurricane Ida 09L2021
#confopts="config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_tutorial_test4a ../parm/hfsa_dev.conf"
