...
#HOMEhafs=/gpfs/dell2/emc/modeling/noscrub/${USER}/save/H221_ensemble_final
#dev="-s sites/wcoss_dell_p3.ent -f"
#PYTHON3=/usrx/local/prod/packages/python/3.6.3/bin/python3

# NOAA WCOSS Cray
#HOMEhafs=/gpfs/hps3/emc/hwrf/noscrub/${USER}/save/H221_ensemble_final
#dev="-s sites/wcoss_cray.ent -f"
#PYTHON3=/opt/intel/intelpython3/bin/python3

# NOAA RDHPCS Jet
#HOMEhafs=/mnt/lfs4/HFIP/hwrf-vd/${USER}/H221_ensemble_final
#dev="-s sites/xjet_ensemble.ent -f"
#PYTHON3=/apps/intel/intelpython3/bin/python3

# MSU Orion
# HOMEhafs=/work/noaa/hurricane/save/${USER}/H221_ensemble_final
# dev="-s sites/orion_ensemble.ent -f"
# PYTHON3=/apps/intel-2020/intel-2020/intelpython3/bin/python3

# NOAA RDHPCS Hera
#HOMEhafs=/scratch1/NCEPDEV/hwrf/save/${USER}/H221_ensemble_final
...
#===============================================================================
 ...
 # hafsv0p2a phase2
 confopts="config.EXPT=${EXPT} config.SUBEXPT=H221_ensemble \
     ../parm/hafsv2021_ensemble_AL.conf \
     ../parm/hafs_hycom.conf"

 confopts_noocean="config.EXPT=${EXPT} config.SUBEXPT=H221_ensemble \
     ../parm/hafsv2021_ensemble_AL.conf"
#Jet
